 ...
 * @brief basic test for etcatlasalpha related API
 * @par TestPoints:
 *
 */
...
bool setupGraphics(int width, int height) {
    ...
    string vertexShaderPath = ((string)GLSL_PATH) + "etc-atlas-alpha.vert"; 
    string fragmentShaderPath = ((string)GLSL_PATH) + "etc-atlas-alpha.frag";
    ...
    GL_CHECK(glClearColor(0.5f, 0.25f, 0.5f, 1.0));
