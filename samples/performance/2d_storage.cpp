...
bool setupGraphics() {
    ...
    GL_CHECK(glTexStorage2D(GL_TEXTURE_2D, 1, GL_RGB8, image_jpg.width, image_jpg.height));
    GL_CHECK(glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, image_jpg.width, image_jpg.height,
...
void Sample::test() {
    ...
    LOGI("storage2d One frame average time:--%f\n", ave_time);
}
