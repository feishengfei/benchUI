...
bool
    ...
    renderFrame() {
        ...
        for(int i=0; i<VERTEX_NUM; i++) {
            GL_CHECK(glVertexAttrib4fv(1, &col[i*4]));
            GL_CHECK(glDisableVertexAttribArray(1));
            GL_CHECK(glDrawArrays(GL_POINTS, i, 1));
        }
    }
...
void Sample::test() {
    ...
    LOGI("vertexattrib One frame average time:--%f\n", ave_time);
}
