...
bool setupGraphics() {
    ...
    GLfloat res[image_jpg.width][image_jpg.height][3];
    GL_CHECK(glGetTexImage(GL_TEXTURE_2D, 0, GL_RGB, GL_UNSIGNED_BYTE, res));
...
void Sample::test() {
    ...
    LOGI("getteximage One frame average time:--%f\n", ave_time);
}
