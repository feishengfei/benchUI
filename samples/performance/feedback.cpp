...
GLfloat data2[VERTEX_NUM];
GLfloat data1[VERTEX_NUM];
...
void  initBuffer()
{
    for (int i = 0; i < VERTEX_NUM; i++) {
        data1[i] = ((float)(rand() % 10));
        data2[i] = ((float)(rand() % 15));
    }
...
void Sample::test() {
    ...
    LOGI("feedback One frame average time:--%f\n", ave_time);
}
