...
bool setupGraphics() {
    ...
    GL_CHECK(glTexStorage2D(GL_TEXTURE_2D, 1, GL_COMPRESSED_RGB8_ETC2, iWidth, iHeight));
    GL_CHECK(glCompressedTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, iWidth, iHeight,
                                       GL_COMPRESSED_RGB8_ETC2, sizeof(image), image));
