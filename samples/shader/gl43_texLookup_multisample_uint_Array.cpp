 ...
 *
 * @file mt_texLookup_multisample_uint_Array.cpp
 * @author Martin.li
 * @par History:
...
void initTexture()
{
    ...
    GL_CHECK(glTexStorage3DMultisample(GL_TEXTURE_2D_MULTISAMPLE_ARRAY, 4, GL_RGBA32UI, 4, 4, 2, GL_TRUE));
...
#ifdef API_ES
    string path = "es32_texLookup_multisample_uint_Array";
#else
    string path = "gl43_texLookup_multisample_uint_Array";
