...
///====================================================================================
    ...
    GLint picture[4] = {0.1, 0.2, 0.4, 0.8};
    GLuint tex;
///====================================================================================
...
void initVBO()
{
    ...
    GL_CHECK(glBufferData(GL_TEXTURE_BUFFER, sizeof(picture), picture, GL_STATIC_DRAW));
}
...
void initTexture()
{
    ...
    GL_CHECK(glTexBuffer(GL_TEXTURE_BUFFER, GL_R32F, VBO_bufferTexture));
}

bool setupGraphics(int width, int height)
{
#ifdef API_ES
    string path = "es32_texelFetch";
#else
    string path = "gl43_texelFetch";
