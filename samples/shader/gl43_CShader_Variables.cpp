...
{
#ifdef API_ES
    path = "es32_CShader_Variables";
#else
    path = "gl43_CShader_Variables";
...
/*
    string compute_shader_Path = path + "/compute_shader.glsl";
    ShaderInfo  shaders[] = {
        { GL_VERTEX_SHADER,   compute_shader_Path.c_str() },
        { GL_NONE, NULL }
    };
