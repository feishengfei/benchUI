 ...
 *
 * @file mt_texLookup_multisample_int.cpp
 * @author Martin.li
 * @par History:
...
void initTexture()
{
    ...
    GL_CHECK(glTexStorage2DMultisample(GL_TEXTURE_2D_MULTISAMPLE, 4, GL_RGBA32I, 4, 4, GL_TRUE));
...
#ifdef API_ES
    string path = "es32_texLookup_multisample_int";
#else
    string path = "gl43_texLookup_multisample_int";
