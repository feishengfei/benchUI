...
{		
	...
	switch (gl_PrimitiveID){
		case 0:{
					imageAtomicXor(imageUnit1, ivec2(1, 0), 0xFFFFFFFF);
					ivec4 col_0 = imageLoad(imageUnit1, ivec2(1, 0));
					results[0] = (col_0.x == 100  ||  col_0.x == (~100));
		} break;
		case 1:{
					imageAtomicXor(imageUnit2, ivec2(1, 0), 0xFFFFFFFFu);
					uvec4 col_1 = imageLoad(imageUnit2, ivec2(1, 0));
		...
		case 4:{
//					imageAtomicExchange(imageUnit0, ivec2(2, 0), 2.1);
					vec4 col_4 = imageLoad(imageUnit0, ivec2(2, 0));
					results[4] = (col_4.x == 2.1);
		} break;
		case 5:{
//					imageAtomicExchange(imageUnit1, ivec2(2, 0), 210);
					ivec4 col_5 = imageLoad(imageUnit1, ivec2(2, 0));
					results[5] = (col_5.x == 210);
		} break;
		case 6:{
					imageAtomicExchange(imageUnit2, ivec2(2, 0), 210u);
					uvec4 col_6 = imageLoad(imageUnit2, ivec2(2, 0));
...
//					imageAtomicExchange(imageUnit4, ivec3(2, 0, 0), 210);
		...
		case 10:{
					imageAtomicCompSwap(imageUnit1, ivec2(3, 0), 300, 301);
					ivec4 col_10 = imageLoad(imageUnit1, ivec2(3, 0));
					results[10] = (col_10.x == 301);
		} break;
		case 11:{
					imageAtomicCompSwap(imageUnit2, ivec2(3, 0), 300u, 301u);
					uvec4 col_11 = imageLoad(imageUnit2, ivec2(3, 0));
