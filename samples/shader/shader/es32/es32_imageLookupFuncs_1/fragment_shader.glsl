...
layout (binding = 0, r32f) uniform highp image2D imageUnit0;
layout (binding = 1, r32i) uniform highp iimage2D imageUnit1;
...
{		
	...
	switch (gl_PrimitiveID){
		...
		case 16:{
					imageAtomicMin(imageUnit1, ivec2(3, 0), 299);
					ivec4 col_16 = imageLoad(imageUnit1, ivec2(3, 0));
					results[16] = (col_16.x == 299);
		} break;
		case 17:{
					imageAtomicMin(imageUnit2, ivec2(3, 0), 299u);
					uvec4 col_17 = imageLoad(imageUnit2, ivec2(3, 0));
		...
		case 20:{
					imageAtomicMax(imageUnit1, ivec2(0, 1), 401);
					ivec4 col_20 = imageLoad(imageUnit1, ivec2(0, 1));
					results[20] = (col_20.x == 401);
		} break;
		case 21:{
					imageAtomicMax(imageUnit2, ivec2(0, 1), 401u);
					uvec4 col_21 = imageLoad(imageUnit2, ivec2(0, 1));
		...
		case 24:{
					imageAtomicAnd(imageUnit1, ivec2(1, 1), 0x0000000F);
					ivec4 col_24 = imageLoad(imageUnit1, ivec2(1, 1));
					results[24] = (col_24.x == 4);
		} break;
		case 25:{
					imageAtomicAnd(imageUnit2, ivec2(1, 1), 0x0000000Fu);
					uvec4 col_25 = imageLoad(imageUnit2, ivec2(1, 1));
		...
		case 28:{
					imageAtomicOr(imageUnit1, ivec2(2, 1), 0x00000009);
					ivec4 col_28 = imageLoad(imageUnit1, ivec2(2, 1));
					results[28] = (col_28.x == 601);
		} break;
		case 29:{
					imageAtomicOr(imageUnit2, ivec2(2, 1), 0x00000009u);
					uvec4 col_29 = imageLoad(imageUnit2, ivec2(2, 1));
