...
void main()
{
	...
	bvec2 v2 = greaterThan(c2, r2);
	bvec3 v3 = greaterThan(c3, r3);
	bvec4 v4 = greaterThan(c4, r4);
	...
	bvec2 iv2 = greaterThan(ic2, ir2);
	bvec3 iv3 = greaterThan(ic3, ir3);
	bvec4 iv4 = greaterThan(ic4, ir4);
	...
	bvec2 uv2 = greaterThan(uc2, ur2);
	bvec3 uv3 = greaterThan(uc3, ur3);
	bvec4 uv4 = greaterThan(uc4, ur4);
