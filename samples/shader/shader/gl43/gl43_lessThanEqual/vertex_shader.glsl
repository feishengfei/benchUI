...
void main()
{
	...
	bvec2 v2 = lessThanEqual(c2, r2);
	bvec3 v3 = lessThanEqual(c3, r3);
	bvec4 v4 = lessThanEqual(c4, r4);
	...
	bvec2 iv2 = lessThanEqual(ic2, ir2);
	bvec3 iv3 = lessThanEqual(ic3, ir3);
	bvec4 iv4 = lessThanEqual(ic4, ir4);
	...
	bvec2 uv2 = lessThanEqual(uc2, ur2);
	bvec3 uv3 = lessThanEqual(uc3, ur3);
	bvec4 uv4 = lessThanEqual(uc4, ur4);
