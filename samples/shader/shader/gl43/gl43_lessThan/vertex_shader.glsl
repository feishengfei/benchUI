...
void main()
{
	...
	bvec2 v2 = lessThan(c2, r2);
	bvec3 v3 = lessThan(c3, r3);
	bvec4 v4 = lessThan(c4, r4);
	...
	bvec2 iv2 = lessThan(ic2, ir2);
	bvec3 iv3 = lessThan(ic3, ir3);
	bvec4 iv4 = lessThan(ic4, ir4);
	...
	bvec2 uv2 = lessThan(uc2, ur2);
	bvec3 uv3 = lessThan(uc3, ur3);
	bvec4 uv4 = lessThan(uc4, ur4);
