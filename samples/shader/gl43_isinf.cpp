...
///====================================================================================
    const int NumPoints = 20; // number of points 
    GLint points[NumPoints*3];
...
{
    GLint theta = -10;
    GLint NaN_test = 0x7f800000; // + infinity
...
void initVAO()
{
    ...
    GL_CHECK(glVertexAttribIPointer(loc1, 3, GL_INT, 0, BUFFER_OFFSET(0)));
...
{
#ifdef API_ES
    string path = "es32_isinf";
#else
    string path = "gl43_isinf";
