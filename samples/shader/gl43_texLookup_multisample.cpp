 ...
 *
 * @file mt_texLookup_multisample.cpp
 * @author Martin.li
 * @par History:
...
void initVAO()
{
    ...
    GL_CHECK(glVertexAttribPointer(loc2_bone, 4, GL_FLOAT, GL_FALSE, 0, BUFFER_OFFSET(sizeof(points_bone))));
...
void initTexture()
{
    ...
    GL_CHECK(glTexStorage2DMultisample(GL_TEXTURE_2D_MULTISAMPLE, 4, GL_RGBA32F, 4, 4, GL_TRUE));
...
#ifdef API_ES
    string path = "es32_texLookup_multisample";
#else
    string path = "gl43_texLookup_multisample";
