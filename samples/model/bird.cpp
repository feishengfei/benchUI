...
//string textureFilename = "Jinx_Base_TX_CM_1.bpm";
...
bool setupGraphics()
{
   ...
   GL_CHECK(glEnable(GL_DEPTH_TEST));
    ...
    string vertexShaderPath = ((string)GLSL_PATH) + "bird.vert"; 
    string fragmentShaderPath = ((string)GLSL_PATH) + "bird.frag";
...
void renderFrame(void)
{
    ...
    Matrix scale = Matrix::createScaling(10.05f, 10.05f,10.05f);  //###add scale by cgj###//
    ...
    GL_CHECK(glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT));
   GL_CHECK(glDrawArrays(GL_TRIANGLES, 0, 17922));
