...
bool setupGraphics()
{
    ...
    string vertexShaderPath = ((string)GLSL_PATH) + "apple.vert"; 
    string fragmentShaderPath = ((string)GLSL_PATH) + "apple.frag";
...
void renderFrame(void)
{
   ...
   // GL_CHECK(glUniform4f(iLocLMaterial_diffuse_color, 0.3333f, 0.1098f, 0.6941f, 1.0f));
    ...
    Matrix scale = Matrix::createScaling(0.060f, 0.060f, 0.060f);
    ...
    GL_CHECK(glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT));
    GL_CHECK(glDrawArrays(GL_TRIANGLES, 0, 195438));
