...
bool setupGraphics()
{
    ...
    string vertexShaderPath = ((string)GLSL_PATH) + "jinx-Alpha.vert"; 
    string fragmentShaderPath = ((string)GLSL_PATH) + "jinx-Alpha.frag";
...
void renderFrame(void)
{
    ...
    //material
    GL_CHECK(glUniform4f(iLocLMaterial_ambient_color, 1.0f, 1.0f,1.0f, 0.5f));
   // GL_CHECK(glUniform4f(iLocLMaterial_ambient_color, 0.3333f, 0.1098f, 0.6941f, 1.0f));
    GL_CHECK(glUniform4f(iLocLMaterial_diffuse_color, 1.0f, 1.0f,1.0f, 0.5f));
   // GL_CHECK(glUniform4f(iLocLMaterial_diffuse_color, 0.3333f, 0.1098f, 0.6941f, 1.0f));
    GL_CHECK(glUniform4f(iLocLMaterial_specular_color,3.0f, 3.0f,3.0f, 0.5f));
