...
bool setupGraphics()
{
   ...
   GL_CHECK(glEnable(GL_DEPTH_TEST));
    ...
    string vertexShaderPath = ((string)GLSL_PATH) + "jinx_512.vert"; 
    string fragmentShaderPath = ((string)GLSL_PATH) + "jinx_512.frag";
...
void renderFrame(void)
{
    ...
    Matrix scale = Matrix::createScaling(0.008, 0.008f,0.008f);  //###add scale by cgj###//
