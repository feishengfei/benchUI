...
void loadShader(void)
{
   ...
   std::string fragmentShaderSource_s =
        ...
        "void main()\n"
        "{\n"
        "FragColor=textureOffset(sampler, texcoord, ivec2("+std::to_string(max_offset)+", "+std::to_string(max_offset)+"));\n}";
...
{
    GL_CHECK(glGetIntegerv(GL_MAX_PROGRAM_TEXEL_OFFSET, &max_offset));
