...
/**
 * @file max-renderbuffer-size.cpp
 * @author Cary.Zhang
 * @par History:
 *    A001: Cary.Zhang, 2020-05-21, Add commit
...
int InitFBO ( ) {
    ...
    GL_CHECK(glRenderbufferStorage(GL_RENDERBUFFER, GL_RGBA8, my_renderbuffer_szie, my_renderbuffer_szie /*WINDOW_W, WINDOW_H*/));
    GLint red_size;
...
bool setupGraphics(int width, int height) {
    string vertexShaderPath   = ((string)GLSL_PATH) + "max-renderbuffer-size.vert";
    string fragmentShaderPath = ((string)GLSL_PATH) + "max-renderbuffer-size.frag";
