...
{		
	...
	switch (gl_PrimitiveID){
		...
		case 2:{
					imageAtomicXor(imageUnit4, 1, 0xFFFFFFFF);
					ivec4 col_2 = imageLoad(imageUnit4, 1);
					results[2] = (col_2.x == 100  ||  col_2.x == (~100));
		} break;
		case 3:{
					imageAtomicXor(imageUnit5, 1, 0xFFFFFFFFu);
					uvec4 col_3 = imageLoad(imageUnit5, 1);
...
//					imageAtomicExchange(imageUnit1, ivec3(2, 0, 0), 210);
		...
		case 7:{
//					imageAtomicExchange(imageUnit3, 2, 2.1);
					vec4 col_7 = imageLoad(imageUnit3, 2);
					results[7] = (col_7.x == 2.1);
		} break;
		case 8:{
//					imageAtomicExchange(imageUnit4, 2, 210);
					ivec4 col_8 = imageLoad(imageUnit4, 2);
					results[8] = (col_8.x == 210);
		} break;
		case 9:{
					imageAtomicExchange(imageUnit5, 2, 210u);
					uvec4 col_9 = imageLoad(imageUnit5, 2);
		...
		case 12:{
					imageAtomicCompSwap(imageUnit4, 3, 300, 301);
					ivec4 col_12 = imageLoad(imageUnit4, 3);
					results[12] = (col_12.x == 301);
		} break;
		case 13:{
					imageAtomicCompSwap(imageUnit5, 3, 300u, 301u);
					uvec4 col_13 = imageLoad(imageUnit5, 3);
