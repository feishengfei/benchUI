...
/**
 * @file etcuncompresalpha.cpp
 * @author Otto.Liu
 * @par History:
 *    A001: Otto.Liu, 2019-08-26, Add commit
 * @brief basic test for etcuncompresalpha related API
 * @par TestPoints:
 *
 */
...
int loadUncompressedAlpha(const char *filename, GLuint *textureID) {
    ...
    unsigned char *textureData = (unsigned char *)calloc(width * height,
