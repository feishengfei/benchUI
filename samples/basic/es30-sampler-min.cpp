...
/**
 * @file sampler-min.cpp
 * @author Otto.Liu
 * @par History:
 *    A001: Otto.Liu, 2019-09-02, Add commit
 * @brief basic test for sampler-min related API
 * @par TestPoints:
 *
 */
...
void renderFrame(GLenum factor) {
    ...
    glSamplerParameteri(sampler, GL_TEXTURE_MIN_LOD,-10);
    glSamplerParameteri(sampler, GL_TEXTURE_MAX_LOD,10);
    ...
    LOGI("glGetSamplerParameteriv(GL_TEXTURE_MIN_FILTER)=%x",get_enum_name(param));
