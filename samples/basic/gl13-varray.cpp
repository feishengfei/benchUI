...
void TestGets(void)
{
    ...
    glGetPointerv(GL_VERTEX_ARRAY_POINTER_EXT, &ptr);
    printf("VERTEX_ARRAY pointer = %x\n", ptr);
    glGetPointerv(GL_NORMAL_ARRAY_POINTER_EXT, &ptr);
    printf("NORMAL_ARRAY pointer = %x\n", ptr);
    glGetPointerv(GL_COLOR_ARRAY_POINTER_EXT, &ptr);
    printf("COLOR_ARRAY pointer = %x\n", ptr);
    glGetPointerv(GL_INDEX_ARRAY_POINTER_EXT, &ptr);
    printf("INDEX_ARRAY pointer = %x\n", ptr);
    glGetPointerv(GL_TEXTURE_COORD_ARRAY_POINTER_EXT, &ptr);
    printf("TEXTURE_COORD_ARRAY pointer = %x\n", ptr);
    glGetPointerv(GL_EDGE_FLAG_ARRAY_POINTER_EXT, &ptr);
...
static void Draw(void)
{
    ...
    glVertexPointer(2, GL_FLOAT, 3, &cv[3]);
    glColorPointer(3, GL_FLOAT, 2, cv);
    ...
    glVertexPointer(2, GL_SHORT, 2, &tv[2]);
    glTexCoordPointer(2, GL_SHORT, 2, tv);
    ...
    glVertexPointer(4, GL_FLOAT, 2, verts2);
