...
static GLubyte subimage_1[subimageSize][subimageSize][4];
static GLubyte subimage_2[subimageSize][subimageSize][4];
static GLubyte subimage_3[subimageSize][subimageSize][4];
static GLubyte subimage_4[subimageSize][subimageSize][4];
static GLubyte subimage_5[subimageSize][subimageSize][4];
static GLubyte subimage_6[subimageSize][subimageSize][4];
...
void makeImages(void) {
   ...
   for (i = 0; i < imageSize; i++) {
    ...
    for (i = 0; i < subimageSize; i++) {
        for (j = 0; j < subimageSize; j++) {
            c = ((((i&0x1)==0)^((j&0x1))==0))*255;
            subimage_1[i][j][0] = (GLubyte) c;
            subimage_1[i][j][1] = (GLubyte) c;
            subimage_1[i][j][2] = (GLubyte) c;
            subimage_1[i][j][3] = (GLubyte) 255;

            subimage_2[i][j][0] = (GLubyte) c;
            subimage_2[i][j][1] = (GLubyte) c;
            subimage_2[i][j][2] = (GLubyte) 0;
            subimage_2[i][j][3] = (GLubyte) 255;

            subimage_3[i][j][0] = (GLubyte) c;
            subimage_3[i][j][1] = (GLubyte) 0;
            subimage_3[i][j][2] = (GLubyte) c;
            subimage_3[i][j][3] = (GLubyte) 255;

            subimage_4[i][j][0] = (GLubyte) 0;
            subimage_4[i][j][1] = (GLubyte) c;
            subimage_4[i][j][2] = (GLubyte) c;
            subimage_4[i][j][3] = (GLubyte) 255;

            subimage_5[i][j][0] = (GLubyte) 255;
            subimage_5[i][j][1] = (GLubyte) c;
            subimage_5[i][j][2] = (GLubyte) c;
            subimage_5[i][j][3] = (GLubyte) 255;

            subimage_6[i][j][0] = (GLubyte) c;
            subimage_6[i][j][1] = (GLubyte) c;
            subimage_6[i][j][2] = (GLubyte) 255;
            subimage_6[i][j][3] = (GLubyte) 255;
        }
    }
}
...
void teximage(GLenum format, GLenum type) {
    ...
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, 0, 0, subimageSize, subimageSize,
                    format, type, subimage_1);
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_X, 0, 0, 0, subimageSize, subimageSize,
                    format, type, subimage_4);
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 0, 0, 0, subimageSize, subimageSize,
                    format, type, subimage_2);
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 0, 0, 0, subimageSize, subimageSize,
                    format, type, subimage_5);
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Z, 0, 0, 0, subimageSize, subimageSize,
                    format, type, subimage_3);
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, 0, 0, subimageSize, subimageSize,
                    format, type, subimage_6);
}
