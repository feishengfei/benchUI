...
/**
 * @file draweleinsbasevert.cpp
 * @author Otto.Liu
 * @par History:
 *    A001: Otto.Liu, 2019-09-02, Add commit
 * @brief basic test for draweleinsbasevert related API
 * @par TestPoints:
 *
 */
...
void drew_Draw_RangeElementsBaseVertex()
{
	...
	glDrawElementsInstancedBaseVertex(GL_TRIANGLES,3,GL_UNSIGNED_SHORT,NULL,4,0);
