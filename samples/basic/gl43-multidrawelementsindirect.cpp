...
GLushort indirect_index[] = {0,4,2,1,2,3,0,3};
GLuint programID;
...
DrawElementsIndirectCommand draw_arrays_indirect[]={
{3,1,0,1,0},
{4,1,3,0,0}
};
...
bool setupGraphics(int width, int height)
{
	...
	GL_CHECK(glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, vertices_bo[1]));
        GL_CHECK(glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(indirect_index), indirect_index, GL_STATIC_DRAW));
...
void renderFrame(GLenum factor) {
	...
	GL_CHECK(glMultiDrawElementsIndirect(factor, GL_UNSIGNED_SHORT, (GLvoid *)0,
