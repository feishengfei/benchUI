 ...
 * @brief basic test for feedback related API
 * @par TestPoints:
 *
 */
...
void initVBO() {
	...
	glGenBuffers(1,&writebuffer);
	glBindBuffer(GL_TRANSFORM_FEEDBACK_BUFFER, writebuffer);
...
void getFBdata() {
	...
	glGetIntegeri_v(GL_TRANSFORM_FEEDBACK_BUFFER_BINDING, writebuffer, &paramui);
