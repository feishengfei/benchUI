...
public:
    ...
    void setupUi(QWidget *cfg_Page)
    {
        ...
        label_configOutform_4->setGeometry(QRect(50, 240, 61, 31));
        QSizePolicy sizePolicy(QSizePolicy::Ignored, QSizePolicy::Ignored);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(label_configOutform_4->sizePolicy().hasHeightForWidth());
        label_configOutform_4->setSizePolicy(sizePolicy);
        QFont font;
        font.setFamily(QString::fromUtf8("\345\276\256\350\275\257\351\233\205\351\273\221"));
        font.setPointSize(10);
        label_configOutform_4->setFont(font);
        label_configOutform_4->setAutoFillBackground(true);
        cfgNextBtn = new QPushButton(cfg_Page);
        cfgNextBtn->setObjectName(QString::fromUtf8("cfgNextBtn"));
        cfgNextBtn->setGeometry(QRect(460, 350, 81, 31));
        sizePolicy.setHeightForWidth(cfgNextBtn->sizePolicy().hasHeightForWidth());
        cfgNextBtn->setSizePolicy(sizePolicy);
        cfgNextBtn->setFont(font);
        cfgNextBtn->setAutoFillBackground(true);
        ...
        configOutformBox_5->setGeometry(QRect(120, 120, 131, 31));
        sizePolicy.setHeightForWidth(configOutformBox_5->sizePolicy().hasHeightForWidth());
        configOutformBox_5->setSizePolicy(sizePolicy);
        configOutformBox_5->setFont(font);
        configOutformBox_5->setAutoFillBackground(true);
        label_configOutform_2 = new QLabel(cfg_Page);
        label_configOutform_2->setObjectName(QString::fromUtf8("label_configOutform_2"));
        label_configOutform_2->setGeometry(QRect(50, 200, 61, 31));
        sizePolicy.setHeightForWidth(label_configOutform_2->sizePolicy().hasHeightForWidth());
        label_configOutform_2->setSizePolicy(sizePolicy);
        label_configOutform_2->setFont(font);
        label_configOutform_2->setAutoFillBackground(true);
        ...
        label_configArch->setGeometry(QRect(50, 80, 61, 31));
        sizePolicy.setHeightForWidth(label_configArch->sizePolicy().hasHeightForWidth());
        label_configArch->setSizePolicy(sizePolicy);
        label_configArch->setFont(font);
        label_configArch->setAutoFillBackground(true);
        label = new QLabel(cfg_Page);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(250, 10, 181, 41));
        ...
        configOutformBox_4->setGeometry(QRect(120, 240, 131, 31));
        sizePolicy.setHeightForWidth(configOutformBox_4->sizePolicy().hasHeightForWidth());
        configOutformBox_4->setSizePolicy(sizePolicy);
        configOutformBox_4->setFont(font);
        configOutformBox_4->setAutoFillBackground(true);
        label_configOutform = new QLabel(cfg_Page);
        label_configOutform->setObjectName(QString::fromUtf8("label_configOutform"));
        label_configOutform->setGeometry(QRect(50, 160, 61, 31));
        sizePolicy.setHeightForWidth(label_configOutform->sizePolicy().hasHeightForWidth());
        label_configOutform->setSizePolicy(sizePolicy);
        label_configOutform->setFont(font);
        label_configOutform->setAutoFillBackground(true);
        cfgSelfCheck = new QCheckBox(cfg_Page);
        cfgSelfCheck->setObjectName(QString::fromUtf8("cfgSelfCheck"));
        cfgSelfCheck->setGeometry(QRect(340, 160, 151, 31));
        sizePolicy.setHeightForWidth(cfgSelfCheck->sizePolicy().hasHeightForWidth());
        cfgSelfCheck->setSizePolicy(sizePolicy);
        cfgSelfCheck->setFont(font);
        cfgSelfCheck->setAutoFillBackground(true);
        configDumpBox = new QCheckBox(cfg_Page);
        configDumpBox->setObjectName(QString::fromUtf8("configDumpBox"));
        configDumpBox->setGeometry(QRect(340, 80, 141, 31));
        sizePolicy.setHeightForWidth(configDumpBox->sizePolicy().hasHeightForWidth());
        configDumpBox->setSizePolicy(sizePolicy);
        configDumpBox->setFont(font);
        configDumpBox->setAutoFillBackground(true);
        ...
        configOutformBox_2->setGeometry(QRect(120, 200, 131, 31));
        sizePolicy.setHeightForWidth(configOutformBox_2->sizePolicy().hasHeightForWidth());
        configOutformBox_2->setSizePolicy(sizePolicy);
        configOutformBox_2->setFont(font);
        configOutformBox_2->setAutoFillBackground(true);
        lineEdit = new QLineEdit(cfg_Page);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setGeometry(QRect(100, 290, 441, 31));
        ...
        configOutformBox->setGeometry(QRect(120, 160, 131, 31));
        sizePolicy.setHeightForWidth(configOutformBox->sizePolicy().hasHeightForWidth());
        configOutformBox->setSizePolicy(sizePolicy);
        configOutformBox->setFont(font);
        configOutformBox->setAutoFillBackground(true);
        label_configLibpath = new QLabel(cfg_Page);
        label_configLibpath->setObjectName(QString::fromUtf8("label_configLibpath"));
        label_configLibpath->setGeometry(QRect(50, 290, 41, 31));
        sizePolicy.setHeightForWidth(label_configLibpath->sizePolicy().hasHeightForWidth());
        label_configLibpath->setSizePolicy(sizePolicy);
        label_configLibpath->setFont(font);
        label_configLibpath->setAutoFillBackground(true);
        ...
        configArchBox->setGeometry(QRect(120, 80, 131, 31));
        sizePolicy.setHeightForWidth(configArchBox->sizePolicy().hasHeightForWidth());
        configArchBox->setSizePolicy(sizePolicy);
        configArchBox->setFont(font);
        configArchBox->setAutoFillBackground(true);
        label_configOutform_5 = new QLabel(cfg_Page);
        label_configOutform_5->setObjectName(QString::fromUtf8("label_configOutform_5"));
        label_configOutform_5->setGeometry(QRect(50, 120, 61, 31));
        sizePolicy.setHeightForWidth(label_configOutform_5->sizePolicy().hasHeightForWidth());
        label_configOutform_5->setSizePolicy(sizePolicy);
        label_configOutform_5->setFont(font);
        label_configOutform_5->setAutoFillBackground(true);
        cfgExitBtn = new QPushButton(cfg_Page);
        cfgExitBtn->setObjectName(QString::fromUtf8("cfgExitBtn"));
        cfgExitBtn->setGeometry(QRect(50, 350, 81, 31));
        sizePolicy.setHeightForWidth(cfgExitBtn->sizePolicy().hasHeightForWidth());
        cfgExitBtn->setSizePolicy(sizePolicy);
        cfgExitBtn->setFont(font);
        cfgExitBtn->setAutoFillBackground(true);
        configGDBBox = new QCheckBox(cfg_Page);
        configGDBBox->setObjectName(QString::fromUtf8("configGDBBox"));
        configGDBBox->setGeometry(QRect(340, 120, 151, 31));
        sizePolicy.setHeightForWidth(configGDBBox->sizePolicy().hasHeightForWidth());
        configGDBBox->setSizePolicy(sizePolicy);
        configGDBBox->setFont(font);
        configGDBBox->setAutoFillBackground(true);
        cfgAPICheck = new QCheckBox(cfg_Page);
        cfgAPICheck->setObjectName(QString::fromUtf8("cfgAPICheck"));
        cfgAPICheck->setGeometry(QRect(340, 200, 151, 31));
        sizePolicy.setHeightForWidth(cfgAPICheck->sizePolicy().hasHeightForWidth());
        cfgAPICheck->setSizePolicy(sizePolicy);
        cfgAPICheck->setFont(font);
        cfgAPICheck->setAutoFillBackground(true);
